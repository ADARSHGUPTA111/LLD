 ...
 * When we have a situation where new responsibility asks arise of an object regularly, it is not
 *  a good idea to keep exntending the class.
 * This is because there can a huge number of combinations of various responsibilities and creating 
 * child classes for each of these is not feasible.
 * Instead we wrap the original class in various decorator classes to provide it with the required
 *  responsibilties.
 * This can be done statically or at runtime.
 * In this example, we have the original object Venue, and we keep decorating it with added
 *  charateristics like Balloons and Lights.
 */
