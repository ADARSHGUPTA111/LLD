 ...
 * Instead of having a separate class manage this externally, it is better to have an utility within 
 * the concerned class itself to create a snapshot.
 ...
 * Editor class is storing a list of all mementos and asks the TextBox class to restore to a certain 
 * memento based on user input (undo/redo).
 */

//  Also refer notes from Udemy course!
// When we save, we take a snapshot for the state for our textbox
 ...
 class Editor {
     ...
     public Editor() {
         ...
         mementoList.add(new Memento("")); // first snapshot at empty file
         pointer = 0;
         textBox = new TextBox();
     }
